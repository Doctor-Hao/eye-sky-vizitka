...
const steps = [
  ...
  { icon: 'mdi-map-outline', title: 'Построение маршрута', description: 'В интерфейсе на карте задаются контрольные точки полета дрона: ширина маршрута, высота полёта и порядок визитов.' },
